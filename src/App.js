      ...
      <div className="app">
         <h1 className='heading'>My ToDo List</h1>
           <input type="text"
             ...
             value={inputItem}
             />
             <button type="button" className="todoBtn" onClick={addItemList}>+</button>
            ...
            listItems.map((list, index)=>{
              ...
              <ol className="list-group list-group-flush">
                <li className="list-group-item d-flex justify-content-between align-items-start list-group-item-action">
                  ...
                  <span className="badge bg-danger bg-gradient rounded-pill removeBtn" onClick={()=>removeItem(index)}>Remove</span>
                </li>
              </ol>
            </div>
            })
